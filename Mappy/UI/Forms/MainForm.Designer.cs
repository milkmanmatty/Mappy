namespace Mappy.UI.Forms
{
    ...
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
	        ...
	        this.cursorSizeNumericUpDown = new Mappy.UI.Controls.StepNumericUpDown();
	        this.cursorSizeLabel = new System.Windows.Forms.Label();
	        this.intervalNumericUpDown = new Mappy.UI.Controls.StepNumericUpDown();
	        this.intervalLabel = new System.Windows.Forms.Label();
	        this.voidTab = new System.Windows.Forms.TabPage();
	        this.voidCursorSizeNumericUpDown = new Mappy.UI.Controls.StepNumericUpDown();
	        ...
	        this.seaLevelTrackbar = new Mappy.UI.Controls.StepTrackBar();
	        ...
	        this.replaceFeatureMenuItem.Size = new System.Drawing.Size(200, 30);
	        ...
	        // featuresMenuItem
	        // 
	        this.featuresMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.replaceFeatureMenuItem, this.clearAllFeaturesMenuItem, toolStripSeparator12, this.fillFeaturesOptionsMenuItem, this.fillSelectionMenuItem });
	        ...
	        // 
	        // clearAllFeaturesMenuItem
	        // 
	        this.clearAllFeaturesMenuItem.Enabled = false;
	        this.clearAllFeaturesMenuItem.Name = "clearAllFeaturesMenuItem";
	        ...
	        // tilesetsMenuItem
	        // 
	        this.tilesetsMenuItem.Name = "tilesetsMenuItem";
	        this.tilesetsMenuItem.Size = new System.Drawing.Size(343, 30);
	        this.tilesetsMenuItem.Text = "Tilesets";
	        this.tilesetsMenuItem.Click += new System.EventHandler(this.TilesetsMenuItemClick);
	        // 
        ...
        private StepNumericUpDown cursorSizeNumericUpDown;
        private System.Windows.Forms.Label cursorSizeLabel;
        private StepNumericUpDown intervalNumericUpDown;
        private System.Windows.Forms.Label intervalLabel;
        private System.Windows.Forms.TabPage voidTab;
        private StepNumericUpDown voidCursorSizeNumericUpDown;
