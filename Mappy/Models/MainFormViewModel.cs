namespace Mappy.Models
{
    ...
    public class MainFormViewModel : IMainFormViewModel
    {
        ...
        {
            this.dispatcher.ShowFillFeaturesOptions();
        }

        public void FillSelectionMenuItemClick()
        {
            this.dispatcher.FillFeatures();
        }
        ...
        private static string FormatMetalSpotStatusValue(Feature feature) =>
            MetalSpotDisplayFormat.FormatDisplayValue(feature);
    }
}
